...
const UserSignUP = () => {
  ...
  const isValid = Boolean(fullname.trim() && email.includes('@') && password.length >= 6)
  ...
  const handleSubmit = async (e) => {
    ...
    const res = await axios.post(`${import.meta.env.VITE_BASE_URL}/api/v1/users/register`, NewUser)
      ...
      <div className="mx-auto flex min-h-screen max-w-6xl items-center px-4 py-12 sm:px-6 lg:px-8">
        <div className="grid w-full gap-10 lg:grid-cols-[1.05fr_0.95fr] lg:items-start">
          <div >
            ...
            <h1 className="mt-4 text-3xl font-bold text-slate-900 lg:text-8xl">
          ...
          <div className="rounded-3xl border border-slate-200 bg-white p-6 shadow-lg shadow-amber-100/60 sm:p-8">
            <div className="flex items-center justify-between">
              <div>
                <h2 className="text-lg font-semibold text-slate-900">User Sign Up</h2>
